      ...
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-background/10 pt-6 sm:pt-8 flex flex-col sm:flex-row justify-between items-center gap-3 text-xs text-background/40">
          ...
          <div className="flex gap-4 sm:gap-6">
            <Link href="/privacy-policy" className="hover:text-background/70 transition-colors">{t.footer.privacyPolicy}</Link>
            <Link href="/terms-of-service" className="hover:text-background/70 transition-colors">{t.footer.termsOfService}</Link>
          </div>
        </div>
