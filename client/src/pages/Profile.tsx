...
import { ExchangeRequestDialog } from "@/components/profile/ExchangeRequestDialog";
...
export default function Profile() {
  ...
  const [exchangeItem, setExchangeItem] = useState<{ orderId: number; item: any } | null>(null);
...
{activeTab === "orders" && <div className="space-y-6">
      ...
      <Dialog open={showDetails} onOpenChange={setShowDetails}>
        <DialogContent className="max-w-lg rounded-md max-h-[90vh] flex flex-col p-0 gap-0">
          <div className="flex items-center px-6 pt-5 pb-4 pe-12 border-b border-border/60 flex-shrink-0">
            <DialogTitle className="font-display text-xl">{t.profile.orderNumber} #{selectedOrderId?.toString().padStart(6, '0')}</DialogTitle>
          </div>
          {orderDetails && (
