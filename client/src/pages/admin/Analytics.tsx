...
import { TrendingUp, Globe, Monitor, RefreshCw, Calendar, ShoppingBag, CreditCard, Banknote, MapPin, Building2 } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-card border border-border rounded-xl p-6">
            ...
            {cityData.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={Math.max(240, cityData.length * 36)}>
