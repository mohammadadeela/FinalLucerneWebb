  ...
  return (
    <AdminLayout>
      ...
      <div className="flex flex-wrap gap-3 mb-5">
        ...
        {/* Print dropdown */}
        <div className="relative" onBlur={(e) => { if (!e.currentTarget.contains(e.relatedTarget as Node)) setShowPrintMenu(false); }}>
          <button
          ...
          {showPrintMenu && (
            <div className="absolute end-0 top-full mt-2 z-50 bg-popover border border-border rounded-xl shadow-2xl overflow-hidden w-64 animate-in fade-in-0 zoom-in-95 duration-150">
              {/* Header */}
