...
CREATE TABLE IF NOT EXISTS products (
  ...
  subcategory_ids  integer[] DEFAULT '{}'::integer[],
  brand            text,
  barcode          text,
  sizes            jsonb     DEFAULT '[]',
  colors           jsonb     DEFAULT '[]',
  size_inventory   jsonb     DEFAULT '{}'::integer[],
...
ALTER TABLE products ADD COLUMN IF NOT EXISTS size_inventory   jsonb   DEFAULT '{}'::integer[];
